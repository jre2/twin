...
## Now
- [ ] Refactor `main()` into explicit update/render systems (`update_movement`, `update_weapons`, `update_particles`, `render_world`, `render_hud`).
- [ ] Audit weapon FSM transitions for switch/reload/charge edge cases and state reset consistency.
